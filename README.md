# Laboratory 4 for the AIC Course

![Polito Logo](resources/logo_polito.jpg)

This repository contains all the materials, scripts, and documentation for the Laboratory 4 conducted as part of the **AI and Cybersecurity** course.
...
> [!NOTE]
> The detailed lab report, including all experimental results and analysis, can be found [here](report/Laboratory4-report.pdf).
